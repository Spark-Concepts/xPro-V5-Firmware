...
#define MACHINE_NAME "CNC_xPRO_V5_Machine_Template"
...
//Option:  Flood coolant - comment out the mist collant line, and unconmment the below line
//#define COOLANT_FLOOD_PIN		GPIO_NUM_21

/*********** Spindle Setup******************/
//Default: PWM spindle control 
#define SPINDLE_TYPE            SpindleType::PWM
#define SPINDLE_OUTPUT_PIN      GPIO_NUM_25
#define SPINDLE_ENABLE_PIN      GPIO_NUM_4
#define DEFAULT_SPINDLE_RPM_MAX     12000 

//Option: RS485 spindle - comment out the PWM spindle block above, uncomment the below block .  
//#define SPINDLE_TYPE            SpindleType::H2A // only one spindle at a time (HuanYang, YL620, or H2A) 
